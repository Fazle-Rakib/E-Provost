                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('profile.store') }} " enctype = "multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="dept_name" type="text" class="form-control @error('dept_name') is-invalid @enderror" name="dept_name" value="{{ old('dept_name') }}" required autocomplete="dept_name" autofocus>
                        ...
                        @if(Auth::user()->user_type == 1)
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="dept_post" type="text" class="form-control @error('dept_post') is-invalid @enderror" name="dept_post" value="{{ old('dept_post') }}" required autocomplete="dept_post" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="hall_post" type="text" class="form-control @error('hall_post') is-invalid @enderror" name="hall_post" value="{{ old('hall_post') }}" required autocomplete="hall_post" autofocus>
                        ...
                        @else
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="reg_number" type="text" required pattern="[0-9]{10}" class="form-control @error('reg_number') is-invalid @enderror" name="reg_number" value="{{ old('reg_number') }}" required autocomplete="reg_number" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="hall_id" type="text" class="form-control @error('hall_id') is-invalid @enderror" name="hall_id" value="{{ old('hall_id') }}" required autocomplete="hall_id" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phn_number" type="tel" required pattern="[0-9]{11}" class="form-control @error('phn_number') is-invalid @enderror" name="phn_number" value="{{ old('phn_number') }}" required autocomplete="phn_number" autofocus>
